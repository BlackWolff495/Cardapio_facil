...
// ===== Liberação manual de acesso (só você usa, via navegador) =====
// Defina ADMIN_SECRET nas variáveis de ambiente do Render.
// Use assim no navegador:
// https://SEU-APP.onrender.com/admin/liberar?email=teste@exemplo.com&dias=30&senha=SUA_SENHA
app.get("/admin/liberar", (req, res) => {
  const ADMIN_SECRET = process.env.ADMIN_SECRET;

  if (!ADMIN_SECRET) {
    return res.status(500).send("ADMIN_SECRET não configurado no servidor.");
  }
  ...
  if (!email || !email.includes("@")) {
    return res.status(400).send("Parâmetro 'email' inválido ou ausente.");
  }
  ...
  assinantes[email] = {
    ...
    nome: "Liberado manualmente"
  };

  salvarAssinantes(assinantes);

  res.send(`✅ Acesso liberado para ${email} até ${expira.toLocaleString("pt-BR")}`);
});
...
app.post("/api/gerar-cardapio", async (req, res) => {
  ...
  const prompt = `Você é um nutricionista e chef brasileiro. Crie um cardápio semanal (seg a dom) para ${prefs.pessoas} pessoas. Objetivo: ${prefs.objetivo}. Orçamento: ${prefs.orcamento}. Restrições: ${prefs.restricoes && prefs.restricoes.length ? prefs.restricoes.join(", ") : "nenhuma"}. Não come: ${prefs.naoCome || "nada"}.

REGRAS OBRIGATÓRIAS:
1. Responda SOMENTE com JSON puro, sem texto antes ou depois, sem markdown, sem backticks
2. Nomes das refeições: máximo 80 caracteres
3. Exatamente 7 dias, exatamente 5 categorias na lista com mínimo 4 itens cada
4. Cada refeição deve ter uma receita com ingredientes (array) e preparo (array de passos curtos)

Formato exato (siga rigorosamente):
{"dias":[{"dia":"Segunda-feira","icone":"🌅","cafe":"nome curto do café","almoco":"nome curto do almoço","jantar":"nome curto do jantar","receitas":{"cafe":{"nome":"Nome do café","ingredientes":["item 1","item 2","item 3"],"preparo":["Passo 1","Passo 2","Passo 3"]},"almoco":{"nome":"Nome do almoço","ingredientes":["item 1","item 2","item 3"],"preparo":["Passo 1","Passo 2","Passo 3"]},"jantar":{"nome":"Nome do jantar","ingredientes":["item 1","item 2","item 3"],"preparo":["Passo 1","Passo 2","Passo 3"]}}}],"lista":{"Hortifrúti":[{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."}],"Proteínas":[{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."}],"Grãos e carboidratos":[{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."}],"Laticínios":[{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."}],"Outros":[{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."},{"nome":"...","quantidade":"..."}]}}

Repita a estrutura de "dias" para todos os 7 dias da semana com ícones: 🌅🌞🌿⚡🎉🌊☀️
Ingredientes: liste com quantidade (ex: "2 ovos", "1 xícara de aveia"). Mínimo 4 ingredientes por receita.
Preparo: mínimo 3 passos claros e objetivos por receita.`;
